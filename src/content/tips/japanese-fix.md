...
description: Grok が英語で答え始めたら、会話の最初に 3 行貼ります。すべて日本語で、英語の資料を貼っても日本語で、話題は一つに絞ります。途中で英語に戻ったら「日本語で続けて」と 1 行で足ります。「日本語で教えて」だけでは、英語の資料を貼ったところで崩れます。設定を探すより先に、会話の中で決めてください。
order: 1
product: chat
...
image_caption: 下の 3 行を先に貼っておくと、英語に戻りにくくなります。「日本語で教えて」だけでは足りません。
---
...
ただし、この設定の名前と場所はバージョンで変わります。2026-09-17 時点では、<a href="https://grok.com">grok.com</a> の設定を開いて自分で探すのが早いです。入口が変わっても効くのは会話の最初の 3 行なので、まずそちらを覚えておいてください。
