...
description: 先に絵を出す。動きは一つ。動画はチャットより早く上限に当たる。720p が 480p になるのは故障ではない。
order: 5
product: imagine
...
絵は出た。動画にすると崩れる。すぐ上限に当たる。720p なのに 480p で返ってくる。

だいたい、動画から書いている。動きを一度に並べている。動画はチャットより減りが早い。
...
2026 年 6 月以降、チャットも Imagine も、上限は 1 週間で 1 つです（<a href="https://docs.x.ai/grok/faq" rel="external">FAQ</a>）。動画を出すと、チャットより早く当たる。残りは設定の Usage。払う場所は <a href="/tips/free-vs-supergrok/">別の TIPS</a>。
...
開発者向けの Imagine API（`grok-imagine-video-1.5`）は <a href="https://console.x.ai" rel="external">console.x.ai</a> の従量です。grok.com の上限とは別。返金なし。チャット用の Imagine と混ぜないでください。
